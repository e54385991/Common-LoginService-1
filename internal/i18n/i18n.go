...
var translations = map[string]map[string]string{
	"en": {
		...
		"admin.binding_settings":         "Account Binding Settings",
		"admin.allow_bind_google":        "Allow binding Google account",
		"admin.allow_unbind_google":      "Allow unbinding Google account",
		"admin.allow_bind_steam":         "Allow binding Steam account",
		"admin.allow_unbind_steam":       "Allow unbinding Steam account",
		"admin.allow_bind_discord":       "Allow binding Discord account",
		"admin.allow_unbind_discord":     "Allow unbinding Discord account",
		"admin.binding_hint_google":      "When enabled, users can bind/unbind Google account in profile",
		"admin.binding_hint_steam":       "When enabled, users can bind/unbind Steam account in profile",
		"admin.binding_hint_discord":     "When enabled, users can bind/unbind Discord account in profile",
		...
		"error.password_too_short":     "Password must be at least %d characters",
		"error.password_require_letter": "Password must contain at least 1 letter",
		"error.password_require_number": "Password must contain at least 1 number",
		"error.password_require_special": "Password must contain at least 1 special character",
		...
		"vip.modal_save":                       "Save",
		"vip.balance_renew":                    "Renew with Balance",
		...
		"messages.delete_confirm":           "Are you sure you want to delete this message?",
		"messages.delete_success":           "Message deleted",
		"messages.mark_read_success":        "Marked as read",
		"messages.mark_all_read_success":    "All messages marked as read",
		"messages.new_messages":             "new messages",
		"messages.view_all":                 "View all messages",
		"messages.empty_title":              "No messages yet",
		"messages.empty_desc":               "You don't have any messages. New messages will appear here.",
		"messages.type_normal":              "Normal",
		"messages.type_system":              "System",
		"messages.type_announcement":        "Announcement",
		"messages.time_just_now":            "Just now",
		...
		"admin.messages_subtitle":           "Send messages to users",
		"admin.send_message":                "Send Message",
		"admin.batch_send":                  "Batch Send",
		"admin.message_title":               "Message Title",
		"admin.message_content":             "Message Content",
		"admin.message_type":                "Message Type",
		"admin.select_users":                "Select Users",
		"admin.all_users":                   "All Users",
		"admin.specific_users":              "Specific Users",
		"admin.user_ids_placeholder":        "Enter user IDs (comma separated)",
		"admin.send":                        "Send",
		"admin.sending":                     "Sending...",
		"admin.send_success":                "Message sent successfully",
		"admin.batch_send_started":          "Batch sending started",
		"admin.batch_progress":              "Sending Progress",
		"admin.batch_total":                 "Total",
		"admin.batch_sent":                  "Sent",
		"admin.batch_failed":                "Failed",
		"admin.batch_status":                "Status",
		"admin.batch_completed":             "Completed",
		"admin.batch_running":               "Running",
		"admin.batch_tasks":                 "Batch Tasks",
		"admin.batch_task_history":          "Batch Task History",
		"admin.no_batch_tasks":              "No batch tasks",
	},
	"zh": {
		// Common
		"app.name":        "Common Login Service",
		...
		"admin.binding_settings":         "账号绑定设置",
		"admin.allow_bind_google":        "允许绑定 Google 账号",
		"admin.allow_unbind_google":      "允许解绑 Google 账号",
		"admin.allow_bind_steam":         "允许绑定 Steam 账号",
		"admin.allow_unbind_steam":       "允许解绑 Steam 账号",
		"admin.allow_bind_discord":       "允许绑定 Discord 账号",
		"admin.allow_unbind_discord":     "允许解绑 Discord 账号",
		"admin.binding_hint_google":      "启用后，用户可在个人中心绑定/解绑 Google 账号",
		"admin.binding_hint_steam":       "启用后，用户可在个人中心绑定/解绑 Steam 账号",
		"admin.binding_hint_discord":     "启用后，用户可在个人中心绑定/解绑 Discord 账号",
		...
		"error.password_too_short":     "密码长度至少%d个字符",
		"error.password_require_letter": "密码必须包含至少1个字母",
		"error.password_require_number": "密码必须包含至少1个数字",
		"error.password_require_special": "密码必须包含至少1个特殊字符",
		...
		"messages.mark_all_read":            "全部标为已读",
		"messages.unread":                   "未读",
		"messages.read":                     "已读",
		"messages.delete":                   "删除",
		"messages.delete_confirm":           "确定要删除此消息吗？",
		"messages.delete_success":           "消息已删除",
		"messages.mark_read_success":        "已标记为已读",
		"messages.mark_all_read_success":    "已全部标记为已读",
		"messages.new_messages":             "条新消息",
		"messages.view_all":                 "查看全部消息",
		"messages.empty_title":              "暂无消息",
		"messages.empty_desc":               "您还没有任何消息，新消息会显示在这里。",
		"messages.type_normal":              "普通",
		"messages.type_system":              "系统",
		"messages.type_announcement":        "公告",
		"messages.time_just_now":            "刚刚",
		...
		// Admin Messages
		"admin.messages":                    "消息管理",
		"admin.messages_subtitle":           "向用户发送消息",
		"admin.send_message":                "发送消息",
		"admin.batch_send":                  "批量发送",
		"admin.message_title":               "消息标题",
		"admin.message_content":             "消息内容",
		"admin.message_type":                "消息类型",
		"admin.select_users":                "选择用户",
		"admin.all_users":                   "全部用户",
		"admin.specific_users":              "指定用户",
		"admin.user_ids_placeholder":        "输入用户ID（逗号分隔）",
		"admin.send":                        "发送",
		"admin.sending":                     "发送中...",
		"admin.send_success":                "消息发送成功",
		"admin.batch_send_started":          "批量发送任务已启动",
		"admin.batch_progress":              "发送进度",
		"admin.batch_total":                 "总计",
		"admin.batch_sent":                  "已发送",
		"admin.batch_failed":                "失败",
		"admin.batch_status":                "状态",
		"admin.batch_completed":             "已完成",
		"admin.batch_running":               "进行中",
		"admin.batch_tasks":                 "批量任务",
		"admin.batch_task_history":          "批量任务历史",
		"admin.no_batch_tasks":              "暂无批量任务",
	},
}
